...
Тема выпускной квалификационной работы \uline{Алгебраические подгруппы комплексно- \hfill}

\uline{го тора \hfill}

Утверждена приказом по~университету № \uline{\paddedtext{1cm}{}} от \uline{\hfill}

Руководитель ВКР: \uline{А. К. Цих, доктор физико-математических наук, профессор, \hfill}

\markedfield{кафедра теории функций Сибирского федерального университета}{инициалы, фамилия, должность, ученое звание и место работы}{1pt}

\vspace{2pt}

Исходные данные для~ВКР: \uline{1.Schmidt, W.~M. Heights of points on subvarieties of $\mathbb{G}^n_m$~/ \hfill}

\uline{W.~M.~Schmidt~// London Mathematical Society Lecture Note Series. Issue~235: Number \hfill}

\uline{Theory. Séminaire de~théorie des~nombres de~Paris 1993–94.~— 1996.~— P.~157—187. \hfill}

\uline{2.~Садыков, Т.~М. Гипергеометрические и~алгебраические функции многих переменн- \hfill}

\uline{ых~/ Т.~М.~Садыков, А.~К.~Цих; Москва : Наука, 2014.~— 408~с.~— ISBN: 978-5-02-03908 \hfill}

\uline{2-9. \hfill}

Перечень разделов ВКР: \uline{1.~Введение. 2.~Задание алгебраических подгрупп тора. \hfill}

\uline{3.~Мономиальные параметризации и~их свойства. 4.~Линейная независимость над~а- \hfill}

\uline{белевой группой. 5.~Голоморфные характеры. 6.~Дальнейшие перспективы. 7.~Список \hfill}

\uline{использованных источников. 8.~Приложение. \hfill}
