...
\uline{3.~Мономиальные параметризации и~их свойства. 4.~Линейная независимость над \hfill}

\uline{абелевой группой. 5.~Голоморфные характеры. 6.~Дальнейшие перспективы. \hfill}

\uline{7.~Список использованных источников. 8.~Приложение. \hfill}
