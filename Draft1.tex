...
\textbf{Алгебраической подгруппой} группы $K$ называется подгруппа, также являющася
...
\begin{theorem*}[Шмидт]
    ...
    системой биномиальных уравнений, то~есть $H = \{ z \in (K^{\times})^n\ |\ \forall i{:}\ z^{\alpha_i} = z^{\beta_i} \}$
    для~некоторых коэффициентов $\alpha_i, \beta_i \in \mathbb{Z}^n$.
\end{theorem*}
