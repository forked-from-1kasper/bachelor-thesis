...
\begin{theorem*}
    $\phi_\alpha : (K^\times)^k \rightarrow (K^\times)^n$ инъективно тогда и~только тогда, когда $\alpha^j$ линейно независимы над~группой $K^\times$.
\end{theorem*}
...
\begin{proof}
    ...
    \begin{align*}
        ...
        \Leftrightarrow\ & (\forall t \in (K^\times)^k{:}\ t^{\alpha_1} = 1 \wedge \ldots \wedge t^{\alpha_n} = 1 \Rightarrow t = 1) \\
        \Leftrightarrow\ & (\forall t_1, \ldots, t_k \in K^\times{:}\ t_1^{\alpha^1} \ldots t_k^{\alpha^k} = 1 \Rightarrow t_1 = \ldots = t_k = 1).
    \end{align*}

    Но~последнее условие~— это в~точности определение линейной независимости над~$K^\times$.
\end{proof}
