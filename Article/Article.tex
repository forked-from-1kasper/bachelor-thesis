...
\noindent{\it Proof.} It follows directly from the~fact that the~injectivity of a~homomorphism is equivalent to the~triviality of~its kernel.
\hfill$\Box$\medskip
...
\bibitem{Art48} Artin, E. Galois Theory~/ E.~Artin; London~: University of~Notre Dame, 1942, 1944.~-- 96~p.~-- ISBN: 978-0-486-62342-9.
