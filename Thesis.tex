...
(то~есть наименьшая подкатегория, содержащая данный подграф) назовём пополнением $\overline{D}$.
...
Говорим, что функтор $T : A \rightarrow B$ \textit{аддитивный,} если для~всякого копроизведения $(c, i, j)$ объектов $a$ и~$b \in \mathrm{Ob}(A)$
