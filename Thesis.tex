...
\begin{titlepage}
  ...
  {\largeАлгебраические подгруппы комплексного тора}
\end{titlepage}
...
\subsection{Мономиальная параметризуемость алгебраических групп}

\subsection{Линейная независимость над абелевой группой}
