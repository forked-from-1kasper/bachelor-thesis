...
\begin{titlepage}
  ...
  \vspace{1.5cm}
  \begin{tabular}{lL{0.15\textwidth}L{0.32\textwidth}l}
...
Наконец, функтор $T : A \rightarrow B$ \textit{полуаддитивен,} если для~всякого копроизведения $(c, i, j)$ объектов $a$ и~$b \in \Ob(A)$
...
\begin{lemma*}[$\eta$-правило]
    Если тровйка $(c, i, j)$ является копроизведением, $x \in \Ob(C)$
