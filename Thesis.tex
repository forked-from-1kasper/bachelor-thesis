...
\bibitem{SE20} Linearly independent over $\mathbb{Z}$, also linearly independent over $\mathbb{R}$? / Y-S.~Smyrlis~//
...
\bibitem{Lean} Programming Language and Theorem Prover~— Lean.~— URL: \url{https://lean-lang.org/} (дата обращения: 01.05.2024).
...
Стандартные двуместные функции будем писать в~инфиксной записи; то~есть $f \circ g$ или~$f \circ_X g$, но~не~$\circ(f, g)$ или~$\circ_X(f, g)$.
